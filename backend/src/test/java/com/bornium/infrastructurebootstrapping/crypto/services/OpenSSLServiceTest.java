...
public class OpenSSLServiceTest {
    ...
    public void test() {
        ...
        openSSLService.createPrivateKey(Paths.get("temp/ca-key.pem"));
        openSSLService.createSelfSignedCert(Paths.get("temp/ca-key.pem"),
                ...
                new X509Subject("DE", "Northrine-Westphalia", "Bonn", "Bornium CA", "*.bornium.com"),
                new SAN(),
                OpenSSLExtension.CA,
                Paths.get("temp/ca-cert.pem"));
        openSSLService.createPrivateKey(Paths.get("temp/server-key.pem"));
